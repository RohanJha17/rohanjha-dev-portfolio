      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:jharohan139@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors text-left"
                  >
                    jharohan139@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 md:space-x-5 justify-center">
                <motion.a
                  ...
                  href="https://www.linkedin.com/in/rohanjha17/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <motion.a
                  whileHover={{ scale: 1.2, rotate: -5 }}
                  href="https://www.instagram.com/rj_rohan07/"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-card p-6 md:p-8 rounded-lg shadow-xs border border-primary/20"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <input
                type="hidden"
                name="access_key"
                value="4b8b3792-461d-405e-8132-fdf9271f17a5"
              />
