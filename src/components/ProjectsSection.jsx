...
const projects = [
  {
    ...
    image: "/knightsync.png",
    tags: ["React.js", "Node.js", "Socket.IO", "WebRTC"],
    demoUrl: "https://knight-sync-production.up.railway.app/",
    githubUrl: "https://github.com/RohanJha17/knight-sync.git",
  },
  {
    id: 2,
    title: "BrewFund - Creator Funding Platform",
    description:
      "BrewFund is a full-stack creator support platform that enables users to make secure micro-donations to creators. It features dynamic user profiles, seamless payment integration, and a simple way for fans to support content they value.",
    image: "/brewfund.png",
    tags: ["Next.js", "NextAuth.js", "MongoDB", "Razorpay API"],
    demoUrl: "https://github.com/RohanJha17/BrewFund.git",
    githubUrl: "https://github.com/RohanJha17/BrewFund.git",
  },
  {
    id: 3,
    title: "Bitlinks - URL Shortener",
    description:
      "A simple and efficient URL shortening service that allows users to create shortened links for easy sharing and tracking.",
    image: "/bitlinks.png",
    tags: ["Next.js", "TailwindCSS", "Next.js API Routes"],
    demoUrl: "https://bitlinks-url-shortener-phi.vercel.app/",
    githubUrl: "https://github.com/RohanJha17/bitlinks-url-shortener.git",
  },
];
        ...
        <div className="text-center mt-12">
          <Reveal width="100%">
            <a
              ...
              target="_blank"
              href="https://github.com/RohanJha17"
            >
