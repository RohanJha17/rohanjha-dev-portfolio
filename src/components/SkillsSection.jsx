  ...
  return (
    <section id="skills" className="py-12 md:py-20 lg:py-24 px-4 md:px-6 lg:px-8 relative bg-secondary/30">
      <div className="container mx-auto max-w-7xl">
        ...
        <Reveal width="100%">
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 md:mb-12 py-2 bg-[#E4DBDE]/30 rounded-full">
            {categories.map((category, key) => (
              <button
                key={key}
                onClick={() => setActiveCategory(category)}
                className={cn(
                  "px-4 md:px-5 py-2 rounded-full transition-all duration-300 capitalize text-sm md:text-base font-medium cursor-pointer",
                  ...
                  >
                    <div className="flex flex-col items-center justify-center gap-4 w-full">
                      ...
                      <div className="flex-1 min-w-[120px] max-w-[200px]">
                        <div className="w-full bg-[#E4DBDE] h-2 rounded-full overflow-hidden">
                          <motion.div
